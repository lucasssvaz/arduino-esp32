...
hello_world|1/1 :white_check_mark:|1/1 :white_check_mark:|0/1 :x:|1/1 :white_check_mark:|Error :fire:|1/1 :white_check_mark:|1/1 :white_check_mark:|1/1 :white_check_mark:
nvs|2/2 :white_check_mark:|2/2 :white_check_mark:|0/1 :x:|4/4 :white_check_mark:|Error :fire:|4/4 :white_check_mark:|2/2 :white_check_mark:|3/3 :white_check_mark:
periman|1/1 :white_check_mark:|1/1 :white_check_mark:|0/1 :x:|1/1 :white_check_mark:|Error :fire:|-|1/1 :white_check_mark:|1/1 :white_check_mark:
psram|10/10 :white_check_mark:|-|0/1 :x:|-|-|8/8 :white_check_mark:|10/10 :white_check_mark:|10/10 :white_check_mark:
timer|3/3 :white_check_mark:|4/4 :white_check_mark:|0/1 :x:|4/4 :white_check_mark:|Error :fire:|4/4 :white_check_mark:|4/4 :white_check_mark:|4/4 :white_check_mark:
touch|3/3 :white_check_mark:|-|-|-|-|3/3 :white_check_mark:|3/3 :white_check_mark:|3/3 :white_check_mark:
uart|11/11 :white_check_mark:|10/10 :white_check_mark:|0/1 :x:|10/10 :white_check_mark:|Error :fire:|10/10 :white_check_mark:|11/11 :white_check_mark:|10/10 :white_check_mark:
unity|2/2 :white_check_mark:|2/2 :white_check_mark:|0/1 :x:|2/2 :white_check_mark:|Error :fire:|2/2 :white_check_mark:|2/2 :white_check_mark:|2/2 :white_check_mark:
...
Generated on: 2025/10/16 03:02:42

[Commit](https://github.com/lucasssvaz/arduino-esp32/commit/c6341c773c8ca6ce89af9bd220c1122b72479f27) / [Build and QEMU run](https://github.com/lucasssvaz/arduino-esp32/actions/runs/18547876277) / [Hardware and Wokwi run](https://github.com/lucasssvaz/arduino-esp32/actions/runs/18547972483) / [Results processing](https://github.com/lucasssvaz/arduino-esp32/actions/runs/18548911375)

[Test results](https://github.com/lucasssvaz/arduino-esp32/runs/52872358360)
